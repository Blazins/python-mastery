...
units =  int(raw_units)
order_cost = effective_unit_cost * units #what we pay: effective unit cost × units.
projected_revenue = retail_inc_vat * units#what customers pay: retail inc VAT × units

print(f"Effective unit cost: £{effective_unit_cost:,.2f}")
